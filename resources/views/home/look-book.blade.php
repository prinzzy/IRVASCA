...
<head>
	...
	<link rel="stylesheet" href="libraries/fuelux/query-ui.min.css">
...
<body data-offset="200" data-spy="scroll" data-target=".primary-navigation">
	...
	<!-- Page Banner -->
	<div id="look-book" class="look-book look-book-banner">
		<h1>Look Book</h1>
	</div>
			...
			<div class="row">
				<div class="col-12 col-md-12 col-lg-5">
					<div class="look-book-img-box">
						...
						<div class="look-book-img-box-hover">
							<ul>
								<li><a title="Eye Icon" href="images/look-book/look-1.jpg"><i class="fa fa-eye"></i></a>
								</li>
					...
					<div class="look-book-img-box">
						...
						<div class="look-book-img-box-hover">
							<ul>
								<li><a title="Eye Icon" href="images/look-book/look-2.jpg"><i class="fa fa-eye"></i></a>
								</li>
								<li><a title="Hert Icon" href="#"><i class="fa fa-heart"></i></a></li>
							</ul>
							<h3>Lace-Up Detail Dress</h3>
						</div>
					</div>
				</div>
				...
				<div class="col-12 col-md-12 col-lg-7">
					<div class="look-book-img-box">
						...
						<div class="look-book-img-box-hover">
							<ul>
								<li><a title="Eye Icon" href="images/look-book/look-3.jpg"><i class="fa fa-eye"></i></a>
								</li>
								<li><a title="Hert Icon" href="#"><i class="fa fa-heart"></i></a></li>
							</ul>
							<h3>Denim Dress</h3>
				...
				<div class="col-12 col-md-12 col-lg-7">
					<div class="look-book-img-box">
						...
						<div class="look-book-img-box-hover">
							<ul>
								<li><a title="Eye Icon" href="images/look-book/look-4.jpg"><i class="fa fa-eye"></i></a>
								</li>
								<li><a title="Hert Icon" href="#"><i class="fa fa-heart"></i></a></li>
							</ul>
							<h3>Pinafore Dress</h3>
						</div>
					</div>
				</div>                                                                                                                                                                                                                                                                                                         
				...
				<div class="col-12 col-md-12 col-lg-5">
					<div class="look-book-img-box">
						...
						<div class="look-book-img-box-hover">
							<ul>
								<li><a title="Eye Icon" href="images/look-book/look-5.jpg"><i class="fa fa-eye"></i></a>
								</li>
								<li><a title="Hert Icon" href="#"><i class="fa fa-heart"></i></a></li>
							</ul>
							<h3>Cape Dresses</h3>
	...
	<script src="libraries/masonry.pkgd.min.js"></script> <!-- Masonry Cascading grid layout -->
