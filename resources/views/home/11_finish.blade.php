	...
	<div class="page-wizard">
		...
		<div class="container">
			...
			<div class="wizard-footer">
				<a title="Back" href="{{ url('/summary-member') }}" class="btn btn-next btn-fill btn-warning btn-wd btn-sm">Back</a>
				<a title="Back To Home" href="{{ url('/summary-member') }}" class="btn btn-next btn-fill btn-warning btn-wd btn-sm">Back
					To Home</a>
			</div>
		</div>
	</div>
