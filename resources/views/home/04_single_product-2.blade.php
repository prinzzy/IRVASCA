					...
					<div class="large-product">
						<div class="row">
							<div id="about-carousel"
								class="col-12 col-md-12 col-lg-3  flexslider product-thumb no-padding">
								<ul class="slides">
									<li>
							...
							<div id="about-slider" class="col-12 col-md-12 col-lg-9 flexslider product-slider">
								<ul class="slides">
									<li>
										<a href="images/single-product/product-large-1.jpg"><img class=""
												src="images/single-product/product-large-1.jpg"
												alt="product-thumb" /></a>
									</li>
									<li>
										<a href="images/single-product/product-large-1.jpg"><img class=""
												src="images/single-product/product-large-2.jpg"
												alt="product-thumb" /></a>
									</li>
									<li>
										<a href="images/single-product/product-large-1.jpg"><img class=""
												src="images/single-product/product-large-3.jpg"
												alt="product-thumb" /></a>
									</li>
									<li>
										<a href="images/single-product/product-large-1.jpg"><img class=""
					...
					<div class="category-box-main product-box-main">
						<div class="row">
							<div class="col-12 col-md-6 col-lg-6 main-product">
								...
								<a title="Fashionable Pink Top" href="#" class="product-title">Pencil Dress</a>
								<ul class="star">
									<li>
							...
							<div class="col-12 col-md-6 col-lg-6 main-product">
								...
								<a title="Fashionable Pink Top" href="#" class="product-title">Asymmetric Dress</a>
								<ul class="star">
									<li>
										<i class="fa fa-star"></i>
										<i class="fa fa-star"></i>
				...
				<div class="col-12 col-md-12 col-lg-5 single-product-sidebar">
					...
					<ul class="star">
						<li>
							...
							<i class="fa fa-star"></i>
							<i class="fa fa-star-o"></i>
							<i class="fa fa-star-o"></i> <span>- ADD Review</span>
						</li>
					</ul>
					...
					<aside class="widget widget_recent_post">
						<div role="tabpanel">
							...
							<ul class="nav nav-tabs bottom-shadow" role="tablist">
								...
								<li class="nav-item" role="presentation"><a title="Size Chart" id="charttab"
										class="nav-link" data-bs-toggle="tab" role="tab" aria-controls="size-chart"
										data-bs-target="#sizechart" aria-selected="false">size chart</a></li>
