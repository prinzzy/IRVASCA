...
<body data-offset="200" data-spy="scroll" data-target=".primary-navigation">
	...
	<div class="contact-form-details">
		<div class="container">
			<div class="row">
				<div class="col-12 col-sm-12 col-md-12 col-lg-6"><!-- User Form -->
					...
					<div class="contact-form">
						<form class="form-horizontal">
							<div class="form-group">
								<div class="row">
									<label for="firstname" class="col-12 col-md-4 col-lg-4">First Name</label>
									<div class="col-12 col-md-8 col-lg-8">
										<input type="text" class="form-control" id="firstname"
											placeholder="enter your first name" required class="require" name="first_name" />
									</div>
								</div>
							</div>
							<div class="form-group">
								<div class="row">
									<label for="lastname" class="col-12 col-md-4 col-lg-4">Last Name</label>
									<div class="col-12 col-md-8 col-lg-8">
										<input type="text" class="form-control" id="lastname"
											placeholder="enter your last name" required class="require" name="last_name" />
									</div>
								</div>
							</div>
							<div class="form-group">
								<div class="row">
									<label class="col-12 col-md-4 col-lg-4">Email Address</label>
									<div class="col-12 col-md-8 col-lg-8">
							...
							<div class="form-group">
								<div class="row">
									<label for="password" class="col-12 col-md-4 col-lg-4">Password</label>
									<div class="col-12 col-md-8 col-lg-8">
							...
							<div class="form-group">
								...
								<a title="Or Return to Shop" href="{{ url('/index') }}" class="submitForm">Or Return to Shop</a>
