			...
			<div class="row">
				...
				<div class="col-12 col-md-12 col-lg-7">
					<div class="large-product">
						<div class="row">
							<div id="about-carousel" class="col-12 col-md-12 col-lg-3 flexslider product-thumb no-padding">
								<ul class="slides">
									...
									@else
									<li>
										<img src="{{ asset('images/default-thumb.jpg') }}" alt="default thumb">
									</li>
									@endif
								</ul>
							</div>
							<div id="about-slider" class="col-12 col-md-12 col-lg-9 flexslider product-slider">
								<ul class="slides">
									...
									@else
									<li>
										<a href="{{ asset('images/default-large.jpg') }}">
											<img src="{{ asset('images/default-large.jpg') }}" alt="default large" />
										</a>
									</li>
									@endif
								</ul>
