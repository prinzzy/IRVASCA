		...
		<div class="container">
			...
			<div class="shopping-cart-table bottom-shadow">
					...
					<tbody>
						<tr>
							...
							<td data-title="Quantity" class="product-quantity">
								<div class="quantity">
									<input type="button" value="+" id="qtyplus-1" class="qtyplus"
				...
				<div class="shopping-cart-footer">
					<a title="Continue Shopping" href="#" class="btn btn-default">Continue Shopping</a>
					<a title="Update Shopping Cart" href="#" class="btn btn-default">Update Shopping Cart</a>
				</div>
			</div>
		</div>
	</div>
