				...
				<div class="row">
					...
					<div class="col-lg-3 col-md-6 col-12">
						<div class="category-box">
							<span class="new">New</span>
							<a title="Kids Wear" href="#">
								<img src="images/category/cat-img-9.jpg" class="lazy img-responsive" data-original=""
									alt="cat-img" />
								<span>Womens Hills</span>
								<div class="cat-hover"></div>
							</a>
						</div>
					</div><!-- col-md-3 /- -->
				...
				<div class="row">
					...
					<div class="col-lg-3 col-md-6 col-12">
						<div class="category-box">
							<span class="new">New</span>
							<a title="Kids Wear" href="#">
								<img src="images/category/cat-img-1.jpg" class="lazy img-responsive" data-original=""
									alt="cat-img" />
					...
					<div class="col-lg-3 col-md-6 col-12">
						<div class="category-box">
							<a title="Women Accessories" href="#">
								<img src="images/category/cat-img-3.jpg" alt="cat-img" />
								<span>Women Shopping bages</span>
								<div class="cat-hover"></div>
							</a>
						</div>
					</div><!-- col-md-3 /- -->
