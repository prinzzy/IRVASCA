	...
	<div class="page-wizard page-wizard1">
		...
		<div class="container">
			<ul class="bottom-shadow">
				...
				<li title="Shipping Address" class="active"><a href="08_Shipping_Address.html">2# Shipping Address</a>
				</li>
			...
			<div class="contact-form-details">
				...
				<div class="contact-form order-summart-text bottom-shadow">
					<h2>Sed consectetur tempus velit ut tincidunt.</h2>
					<p>Aliquam placerat, mi non interdum volutpat, nisi magna euismod arcu, at congue augue ex nec
						lectus. Phasellus fermentum libero id neque rhoncus, sed posuere sem dictum. In nec fermentum
						ante. Morbi et massa arcu. Suspendisse tempus mattis viverra. </p>
				</div>
			...
			<div class="page-content">
				<p>Aliquam placerat, mi non interdum volutpat, nisi magna euismod arcu, at congue augue ex nec lectus.
					Phasellus fermentum libero id neque rhoncus, sed posuere sem dictum. In nec fermentum ante. Morbi et
					massa arcu. Suspendisse tempus mattis viverra.</p>
			</div>
			<!-- Comment-area -->
			...
			<div class="shopping-cart-table bottom-shadow">
				...
				<div class="row">
					<div class="product-content col-12 col-md-12 col-lg-8">
						...
						<p>Vivamus maximus dictum ex, eget finibus sapien. Nam dictum risus sed fringilla imperdiet.
							Fusce
							sem sem, eleifend in nulla nec, tincidunt accumsan eros. Aliquam aliquet rhoncus nibh, ac
							pellentesque urna semper quis. Suspendisse eget enim venenatis, vulputate quam nec,
							porttitor
							lorem.</p>
					</div>
			...
			<div class="wizard-footer">
				<a title="Back" href="09_payment.html" class="btn btn-next btn-fill btn-warning btn-wd btn-sm">Back</a>
				<a title="Continue" href="11_finish.html"
