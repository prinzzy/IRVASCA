	...
	<div class="container">
		<div class="page-breadcrumb">
			...
			<div class="return-home-link pull-right">
				<a title="Return Home Page" href="{{ url('/index') }}">return to home page</a>
			</div>
		</div>
	...
	<div class="page-wizard">
		...
		<div class="container">
			...
			<div class="contact-form-details payment-getway-option">
				<div class="row">
					<div class="col-12 col-md-12 col-lg-6"><!-- User Form -->
					...
					<div class="col-12 col-md-12 col-lg-6">
						...
						<div class="contact-form bottom-shadow">
							<form>
								<div class="radio">
									<input type="radio" name="r" id="radio1"><label for="radio1">Cash on Delivery
										<span>7,86 Dollar </span></label>
								</div>
								<div class="radio">
									<input type="radio" name="r" id="radio2"><label for="radio2">Secure Payment by
										Credit Card - CardPay</label>
								</div>
								<div class="radio">
			...
			<div class="wizard-footer">
				<a title="Back" href="08_Shipping_Address.html"
					class="btn btn-next btn-fill btn-warning btn-wd btn-sm">Back</a>
				<a title="Continue" href="10_summary.html"
