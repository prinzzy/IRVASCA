...
<body data-offset="200" data-spy="scroll" data-target=".primary-navigation">
	...
	<!-- Page Banner -->
	<div class="page-banner  page-inner-banner">
		<h1>Who are we?</h1>
	</div>
	<!-- Page Banner /- -->
	...
	<div id="about-section" class="about-section bottom-shadow">
		<!-- Container -->
		<div class="container">
			<h4>IRVASCA is an apparel brand and focused on men's and woman's clothing products. IRVASCA tries to present product for youth who want to look trendy, semi-formal. casual and convenience. IRVASCA uses the best material from IRVASCA QC for each of our product. We manufacture our product with high technology and experienced human resources to produce fine tallor-made outfit that fulfill IRVASCA product standard.</h4>
