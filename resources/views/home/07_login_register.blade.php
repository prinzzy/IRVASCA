			...
			<div class="contact-form-details row">
				...
				<div class="col-12 col-md-12 col-lg-6">
					...
					<div class="contact-details new-user-register register-user bottom-shadow">
						<h3>Sed consectetur tempus velit ut tincidunt.</h3>
						<p>Aliquam placerat, mi non interdum volutpat, nisi magna euismod arcu, at congue augue ex nec
							lectus. Phasellus fermentum libero id neque rhoncus, sed posuere sem dictum. In nec
							fermentum ante. Morbi et massa arcu. Suspendisse tempus mattis viverra. </p>
						<div class="drop-line bottom-shadow"></div>
						<a title="Continue" href="08_Shipping_Address.html"
