			...
			<div class="contact-form-details row">
					...
					<div class="contact-form bottom-shadow">
						<form class="form-horizontal login-page">
							...
							<div class="form-group">
								...
								<a title=">Forgot Password " href="#" class="submitForm">Forgot your Password ?</a>
							</div>
						</form>
					</div>
				</div><!-- col-md-6 /- -->
				...
				<div class="col-12 col-md-12 col-lg-6">
					...
					<div class="contact-details new-user-register register-user bottom-shadow">
						...
						<p>You need to create account first, click continue. </p>
						<div class="drop-line bottom-shadow"></div>
						<a title="Continue" href="{{ url('/register-member') }}"
