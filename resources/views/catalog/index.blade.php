...
<head>
    ...
    <style>
        ...
        .hero {
            ...
            padding: 0.1rem 0 !important; /* Adjusted padding for smaller hero section */
            margin: 0 !important;
        }
        .hero .btn-warning {
        ...
        header {
            background-color: #520055 !important;
            color: #ffffff !important;
            padding: 0.1rem 0 !important; /* Adjusted padding for smaller header */
...
<header class="bg-dark-custom text-white">
    <div class="container d-flex justify-content-between align-items-center">
        <img src="{{ asset('images/logo/logo_ungu.jpg') }}" alt="IRVASCA Logo" style="width: 100px; height: auto;">
